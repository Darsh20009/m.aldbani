        ...
        <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="space-y-3 mb-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full flex items-center justify-center gap-3 h-12 rounded-xl font-semibold text-sm bg-white transition-all hover:shadow-md disabled:opacity-60 disabled:cursor-not-allowed"
            ...
            >
              ...
              {googleLoading ? t("Signing in…", "جاري التحقق…") : t("Continue with Google", "المتابعة بـ Google")}
            </motion.button>
