    ...
    <AdminLayout>
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-white/60">Manage bookings, schedules, and meeting links.</p>
        </div>
      </div>
          ...
          <TableBody>
            {isLoading ? (
              <TableRow className="border-white/10">
                <TableCell colSpan={6} className="text-center py-8 text-white/50 animate-pulse">Loading consultations...</TableCell>
              </TableRow>
            ) : consultations.length === 0 ? (
              <TableRow className="border-white/10">
                <TableCell colSpan={6} className="text-center py-8 text-white/50">No consultations found.</TableCell>
              </TableRow>
            ) : (
              consultations.map((c) => (
                <TableRow key={c.id} className="border-white/10 hover:bg-white/5">
                  ...
                  <TableCell>
                    ...
                    <div className="text-xs text-white/50">{c.clientEmail}</div>
                  </TableCell>
                  ...
                  <TableCell className="text-right">
                    <Button variant="ghost" size="sm" className="text-white/60 hover:text-white">Manage</Button>
                  </TableCell>
                </TableRow>
              ))
            )}
