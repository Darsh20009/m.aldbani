        ...
        <Table>
          <TableHeader>
            <TableRow className="border-white/10 hover:bg-transparent">
              <TableHead className="text-white/60">{t("Invoice #", "رقم الفاتورة")}</TableHead>
              <TableHead className="text-white/60">{t("Date", "التاريخ")}</TableHead>
              <TableHead className="text-white/60">{t("Amount", "المبلغ")}</TableHead>
            ...
            {isLoading ? (
              [1, 2, 3].map(i => (
                <TableRow key={i} className="border-white/10 hover:bg-white/5">
                  <TableCell><div className="h-4 bg-white/10 rounded w-20 animate-pulse" /></TableCell>
                  ...
                  <TableCell><div className="h-8 bg-white/10 rounded w-20 ml-auto animate-pulse" /></TableCell>
                </TableRow>
              ))
            ) : invoices.length === 0 ? (
              <TableRow className="border-white/10 hover:bg-transparent">
